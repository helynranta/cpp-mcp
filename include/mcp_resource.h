...
public:
     ...
     */
    text_resource(const std::string& uri, const std::string& name, const std::string& mime_type,
...
public:
     ...
     * @param description Optional description of the resource
     */
    binary_resource(const std::string& uri, const std::string& name, const std::string& mime_type,
                    const std::string& description = "");
...
public:
     ...
     * @param description Optional description of the resource
     */
    file_resource(const std::string& file_path, const std::string& mime_type = "", const std::string& description = "");
