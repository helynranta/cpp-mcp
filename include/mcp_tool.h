...
public:
    ...
    tool_builder& with_array_param(const std::string& name, const std::string& description,
                                   const std::string& item_type, bool required = true);
     ...
     * @return Reference to this builder
     */
    tool_builder& with_object_param(const std::string& name, const std::string& description, const json& properties,
                                    bool required = true);
 ...
 */
inline tool
create_tool(const std::string& name, const std::string& description,
